...
--
-- Host: localhost
-- Generation Time: Feb 13, 2019 at 10:48 PM
...
CREATE TABLE `incubation_centers` (
  ...
  `incubation_center_name` varchar(200) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `startups_info` (
  ...
  `startup_cin` varchar(200) COLLATE utf8_bin NOT NULL COMMENT 'Startup Corporate Identification Number',
